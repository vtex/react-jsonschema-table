          ...
          var actionIcons = that.props.isFocus
            ? (<div>
              <Icon
                ...
                key={'card-link-' + index}
                className={
                    'pointer mid-gray ml2 fa fa-pencil-alt dim' +
                      (item.id ? '' : '  o-30 cursor-not-allowed')
                  }
              ...
              <Icon
                ...
                className={'pointer mid-gray ml2 fa fa-trash dim'}
    ...
    if (!this.state.initInEditingMode) {
      ...
      listLinksDiv = (
        <div
          ...
          className={
            'flex items-center  h-inherit' +
              (this.props.isFocus
                ? ' relative bw1 ba ' +
                    borderColor +
                    ' bg-lightest-blue truncate'
                : this.props.hasError ? 'bw1 ba b--red' : '') +
              (this.state.isSingleLine ? ' ph2 pv1' : '')
          }

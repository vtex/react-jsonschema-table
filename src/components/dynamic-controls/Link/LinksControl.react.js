      ...
      allRowCards.push(
        ...
        >
          <Icon
            ...
            key={'card-link-' + index}
            className={
              'top-1 right-2 absolute white  br-100 f1 mr3 w2 h2 pt1 tc nt3 fa fa-pencil-alt' +
                (item.id
                  ? ' dim bg-black-90 pointer'
                  : '  bg-black-40 o-30 cursor-not-allowed')
            }
          ...
          <Icon
            ...
            className={
              'top-1 right-0 absolute white bg-black-90 mr2 ml1 br-100 f1 w2 h2 pt1 tc nt3 dim fa fa-trash pointer'
            }
